      ...
      <div className="bg-white w-full max-w-lg p-10 rounded-2xl shadow-xl border border-gray-100">
        ...
        <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
                {/* DÜZELTME 1: text-brand-blue yerine text-blue-600 yapıldı */}
                <div className="p-3 bg-blue-600/10 rounded-xl text-blue-600"><FaUserShield /></div>
                Hesap Ayarları
            </h2>
            {/* DÜZELTME 2: hover:text-brand-blue yerine hover:text-blue-600 yapıldı */}
            <Link to="/admin/dashboard" className="text-sm font-medium text-gray-500 hover:text-blue-600 flex items-center gap-1 transition">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-1">
            ...
            <div className="relative">
                ...
                {/* DÜZELTME 3: brand-blue olan border ve ring renkleri blue-600 yapıldı */}
                <input type="password" required className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 outline-none transition" 
                  placeholder="••••••••"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
                ...
                <input type="password" required className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 outline-none transition" 
                placeholder="••••••••"
          ...
          {/* DÜZELTME 4 (EN ÖNEMLİSİ): 'bbg-blue-600' yazan yer 'bg-blue-600' olarak düzeltildi */}
          <button type="submit" className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-xl hover:bg-blue-800 flex items-center justify-center gap-2 transition shadow-lg shadow-blue-200 mt-4">
